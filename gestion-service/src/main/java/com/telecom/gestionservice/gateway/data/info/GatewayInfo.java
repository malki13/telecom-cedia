package com.telecom.gestionservice.gateway.data.info;
...
public class GatewayInfo {
    ...
    public GatewayInfo(Integer iden, String nombre, String descripcion, String idGateway, String idNetworkServer, Double altitude, Double latitude, Double longitude, Integer idEmpresa) {
        this.iden = iden;
        this.nombre = nombre;
